      ...
      <button class="btn btn-outline-success my-2 my-sm-0" type="submit">Search</button>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-5 col-md-6 col-12">
                        <img src="Photos/JPEG%20image%208.jpeg " class="img-fiuid aboutusimg">
                    </div>
                     <div class="col-lg-5 col-md-6 col-12">
                        <h2 class="display-4"> Food Ordering</h2>
                        <p>This is the simple food odering web site. we provide delicious foods. we deliver food at your door..</p>
                    </div>
                </div>
            </div>
        </section>
       ...
       <!__.......................................................................__> 
        ...
        <a class="navbar-brand" href="#"> 
               <h2 class= "align-center">   Comments </h2> 
            <form method="post" action="commentInsert.php">
                            ...
                            <div class="form-group">
                                ...
                                <textarea  name="message" rows="4" cols="50" placeholder="your comment">
 
                                </textarea>
                            </div>
                            
                            <button type="submit" name="comments" class="btn btn-success" > Submit</button>
            ...
            <div class="container text-center text-md-left mt-5">
                <div class="row">
                    <div class="col-md-3 mx-auto mb-4">
                        ...
                        <p class="mt-2">Sea Foods, Meat and Vegotarion foods we distribute </p>
                    </div>
                    <div class="col-md-2 mx-auto mb-4">
                       ...
                       <ul class="list-unstyled">
                           <li class="my-2"><a href="#">HTML 5</a></li>
                            ...
                            <li class="my-2"><a href="#">Boostrap 4</a></li>
                   ...
                   <div class="col-md-2 mx-auto mb-4">
                        ...
                        <hr class="bg-success mb-4 mt-0 d-inline-block mx-auto" style="width: 110px; height:2px;">
                           ...
                           <li class="my-2"><a href="#">Home</a></li>
                            <li class="my-2"><a href="#">Menu</a></li>
                     ...
                     <div class="col-md-3 mx-auto mb-4">
                        ...
                        <hr class="bg-success mb-4 mt-0 d-inline-block mx-auto" style="width: 110px; height:2px;">
                            <ul class="list-unstyled">
                           <li class="my-2"><i class="fas fa-home mr-3"></i> Galle,Neluwa</li>
                            <li class="my-2"><i class="fas fa-envelope mr-3"></i>jfoodsorder@gmil.com</li>
                            <li class="my-2"><i class="fas fa-phone mr-3"></i>+9212378534</li>
                            <li class="my-2"><i class="fas fa-print mr-3"></i>+00223344667788</li>
                        </ul>
                    </div>  
                </div>
            </div>
